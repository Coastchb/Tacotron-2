...
hparams = tf.contrib.training.HParams(
	...
	b_use_reaper=True, # If True: Reaper is used for f0 extraction. If False: The vocoder(World) is used for f0 extraction.
	...
	tacotron_test_size = 0.01, #% of data to keep as test data, if None, tacotron_test_batches must be not None. (5% is enough to have a good idea about overfit)
